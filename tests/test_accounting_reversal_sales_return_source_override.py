...
def test_preserves_sales_return_source_by_default():
    assert (
        _resolve_reversal_sales_return_recognition_event_id(
            original_sales_return_recognition_event_id=10,
            override=None,
        )
        == 10
    )
...
def test_none_remains_none_without_override():
    assert (
        _resolve_reversal_sales_return_recognition_event_id(
            original_sales_return_recognition_event_id=None,
            override=None,
        )
        is None
    )
...
def test_override_requires_sales_return_original():
    with pytest.raises(
        AccountingReversalError,
...
def test_reverse_journal_entry_exposes_sales_return_override():
...
def test_reverse_journal_entry_wires_sales_return_source():
