...
def test_current_business_source_contract_is_11_sources():
    assert len(
        BUSINESS_SOURCES
    ) == 11


def test_current_business_source_contract_has_55_pairs():
    pairs = tuple(
        combinations(
            BUSINESS_SOURCES,
            2,
...
def test_exclusivity_check_contains_all_55_pairs():
    import re
